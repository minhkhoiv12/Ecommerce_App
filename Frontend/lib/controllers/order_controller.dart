  ...
  Future<Map<String, dynamic>> createPaymentIntent({
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception(
          'Tạo ý định thanh toán không thành công: ${response.body}',
        );
      }
    } catch (e) {
      throw Exception('Lỗi khi tạo ý định thanh toán: $e');
    }
  }
  ...
  Future<Map<String, dynamic>> getPaymentIntentStatus({
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception(
          'Lấy trạng thái ý định thanh toán không thành công: ${response.body}',
        );
      }
    } catch (e) {
      throw Exception('Lỗi khi lấy trạng thái ý định thanh toán: $e');
    }
  }
}
